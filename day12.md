...
- 請嘗試 Vibe，Coding 美化妙麗年齡計算機
- 填寫生日資訊，按出計算後，會顯示狗與人類年齡
- 重新整理後，能出現上次運算結果(使用 localstorage)
...
- 自訂 constitution.md 規範不可違背原則
- 建立工作任務 task.md 描述開發需求
- 使用原生語法，無第三方套件
- 支援 RWD
- 新增 unsplash 背景圖輪播
- 新增計算歷史紀錄
...
```
The constitution is a non-negotiable principle.

- Only development in index.html, style.css and lib.js.
- Always use native HTML, CSS, and JavaScript, and avoid any fontend-frameworks.
- **MUST NOT** use any third party lib.
```
...
```
base on @constitution.md, implement @task.md
```